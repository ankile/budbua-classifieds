...
class Test_JWT_Authentication(TestCase):
    ...
    def test_produce_jwt_token(self):
        ...
        jwt_auth_response_success = client.post(jwt_auth_url, {'email': TEST_EMAIL, 'password': TEST_PASSWORD},
                                                format='json')
    ...
    def test_verify_jwt_token(self):
        ...
        test_user.save()
        jwt_auth_url = '/users/api-token-auth/'
        jwt_auth_get_token_response = getTokenClient.post(jwt_auth_url,
