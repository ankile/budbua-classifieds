...
class Test_Report_View(TestCase):
    ...
    def test_post_user_rating_via_rest(self):
        ...
        inserting_success_user_rating = self.getTokenClient.post(self.good_post_user_rating, {'rating':4}, format='json')
    ...
    def test_put_user_rating_via_rest(self):
        ...
        inserting_success_put_user_rating = self.getTokenClient.put(self.good_put_user_rating, {'rating':3}, format='json')
