...
class Test_Ads_View(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.jwt_auth_get_token_response_test_user = cls.authorizedClient.post(jwt_auth_url, {'email': TEST_EMAIL,
        ...
        cls.jwt_auth_get_token_response_test_user_unauth = cls.unauthorizedClient.post(jwt_auth_url, {
            'email': 'kent@notallowedtodelete.no', 'password': TEST_PASSWORD}, format='json')
